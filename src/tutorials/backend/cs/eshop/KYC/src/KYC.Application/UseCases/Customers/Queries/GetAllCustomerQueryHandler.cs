...
public class GetAllCustomerQueryHandler(ICustomerQueryRepository repository
    ...
    : IRequestHandler<GetAllCustomerQuery, Result<IEnumerable<CustomerQueryModel>>>
{
          ...
          CancellationToken cancellationToken)
    {
        ...
        return Result<IEnumerable<CustomerQueryModel>>.Success(await _readOnlyRepository.GetAllAsync());
    }
}
